...
/* harmony export */   "initDeleteModal": () => (/* binding */ initDeleteModal)
/* harmony export */ });
...
function initDeleteModal() {
  ...
  var modal = document.getElementById('form-builder-delete-modal');
  ...
  initialized = true;
  var cancelButtons = modal.querySelectorAll('[data-fb-delete-cancel]');
  var confirmButton = modal.querySelector('[data-fb-delete-confirm]');
  cancelButtons.forEach(function (button) {
    button.addEventListener('click', function () {
      return closeDeleteModal(false);
    });
  });
  confirmButton === null || confirmButton === void 0 ? void 0 : confirmButton.addEventListener('click', function () {
...
function confirmDeleteField(fieldOrLabel) {
  var modal = document.getElementById('form-builder-delete-modal');
  var context = normalizeDeleteContext(fieldOrLabel);

  if (!modal) {
    var _context$label;

    var name = ((_context$label = context.label) === null || _context$label === void 0 ? void 0 : _context$label.trim()) || 'this field';
    return Promise.resolve(window.confirm("Delete \"".concat(name, "\"? This cannot be undone.")));
  }
  ...
  return new Promise(function (resolve) {
    ...
    var keepButton = document.getElementById('form-builder-delete-keep');
    window.requestAnimationFrame(function () {
      keepButton === null || keepButton === void 0 ? void 0 : keepButton.focus();
    });
  });
}
/**
...
function normalizeDeleteContext(fieldOrLabel) {
  ...
  return fieldOrLabel !== null && fieldOrLabel !== void 0 ? fieldOrLabel : {};
}
/**
...
function populateDeleteModal(context) {
  var _context$label2, _meta$label, _meta$icon;

  var iconEl = document.getElementById('form-builder-delete-field-icon');
  var typeEl = document.getElementById('form-builder-delete-field-type');
  var nameEl = document.getElementById('form-builder-delete-field-name');
  var meta = context.type ? (0,_constants__WEBPACK_IMPORTED_MODULE_0__.getFieldTypeMeta)(context.type) : undefined;
  var label = ((_context$label2 = context.label) === null || _context$label2 === void 0 ? void 0 : _context$label2.trim()) || 'Untitled field';
  var typeLabel = (_meta$label = meta === null || meta === void 0 ? void 0 : meta.label) !== null && _meta$label !== void 0 ? _meta$label : 'Form field';
  var icon = (_meta$icon = meta === null || meta === void 0 ? void 0 : meta.icon) !== null && _meta$icon !== void 0 ? _meta$icon : '◆';
...
function handleConfirmClick(_x) {
  return _handleConfirmClick.apply(this, arguments);
}
/**
...
function _handleConfirmClick() {
  _handleConfirmClick = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(confirmButton) {
...
function closeDeleteModal(confirmed) {
  var _releaseFocusTrap;

  var modal = document.getElementById('form-builder-delete-modal');
  var confirmButton = document.getElementById('form-builder-delete-confirm');
  ...
  modal === null || modal === void 0 ? void 0 : modal.classList.remove('form-builder-delete-modal--open');
  document.body.classList.remove('overflow-hidden');
  (_releaseFocusTrap = releaseFocusTrap) === null || _releaseFocusTrap === void 0 ? void 0 : _releaseFocusTrap();
...
function trapFocus(modal) {
  var panel = modal.querySelector('.form-builder-delete-modal__panel');
  ...
  var handleKeyDown = function handleKeyDown(event) {
    ...
    var focusable = _toConsumableArray(panel.querySelectorAll(selector)).filter(function (el) {
...
function initFieldActions() {
  ...
  fieldsList.addEventListener('click', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
      var actionButton, card, fieldId, action, field;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              actionButton = event.target.closest('[data-fb-action]');
            ...
            case 3:
              card = actionButton.closest('[data-field-id]');
            ...
            case 6:
              ...
              action = actionButton.getAttribute('data-fb-action');
              _context.t0 = action;
              _context.next = _context.t0 === 'delete' ? 13 : _context.t0 === 'duplicate' ? 19 : _context.t0 === 'edit' ? 21 : _context.t0 === 'move' ? 24 : 24;
              break;

            case 13:
              field = (0,_state__WEBPACK_IMPORTED_MODULE_1__.getFields)().find(function (item) {
                return item.id === fieldId;
              });
              _context.next = 16;
              return (0,_confirm__WEBPACK_IMPORTED_MODULE_0__.confirmDeleteField)({
...
function handleRemoveElement() {
  return _handleRemoveElement.apply(this, arguments);
}
/**
...
function _handleRemoveElement() {
  _handleRemoveElement = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var field;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            field = (0,_state__WEBPACK_IMPORTED_MODULE_3__.getSelectedField)();
...
/* harmony import */ var _confirm__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./confirm */ "./resources/js/form-builder/confirm.js");
...
document.addEventListener('DOMContentLoaded', function () {
  (0,_confirm__WEBPACK_IMPORTED_MODULE_9__.initDeleteModal)();
